<template>
  <b-container class="text-justify" id="content">
    ...
    <ul class="list-unstyled">
        ...
        <p>Aby AI dávala smysluplné výsledky, nestačí jen otevřít chat a doufat. Používám skills, MCP servery, další dostupné nástroje a agent mode.
    ...
    (tzv. <i>continuous deployment</i>). Žádné zdlouhavé kopírování souborů na FTP server a podobně.</p>
...
export default {
    name: 'Tech',
    components: { CodeLi, TechTable, Buzzwords }
}
</script>
