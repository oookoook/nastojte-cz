...
<div class="media mb-3">
  <img src="../assets/photo.jpg" class="align-self-center mr-3 rounded photo" alt="My face">
...
zaměstnaný od roku 2008.</p>
                ...
                působím jako vývojář na volné noze.</p>
  </div>
</div>
<div class="jumbotron">
    ...
    export default {
        ...
        data: function () {
            return {
                ...
                {
                    category: 'Microton',
                    title: 'Joolca troubleshooting',
                    year: 2018,
                    img: require('../assets/code.png'),
                    link: '',
                    description: 'Interaktivní rozhovací strom pro základní zákaznickou podporu '
                    ...
                    technologies: ['Javascript', 'jQuery', 'REST', { name: 'Google Aps Script', icon: 'https://developers.google.com/site-assets/developers_64dp.png'}, 'Google GSuite']
                }, {
                    category: 'Microton',
                    title: 'Dropair',
                    year: 'od 2017',
                    ...
                    technologies: [ {name: 'Vue.js', cname: 'vue' }, {name: 'Mapy.cz API', icon: 'http://api.mapy.cz/img/web/logo.gif'}, 'Webpack', 'Bootstrap', 'Node.js', 'Express', 'AWS Lambda', 'AWS DynamoDB']
                }, {
                    category: 'Volná noha',
                    ...
                    year: '2017',
                    img: require('../assets/code.png'),
                    link: 'https://gitlab.fi.muni.cz/xkucer16/semanticBMS',
                ...
                tools: [
                    ...
                    { category: 'Frontend',
                        like: [ {name: 'Vue.js', cname: 'vue' } ], know: [ {name: 'AngularJS', icon: 'https://angularjs.org/img/AngularJS-large.png' }, 'jQuery', 'Javascript', { name: '.NET Framework', cname: 'dotnet'} ] },
                    { category: 'Backend',
                        like: [ 'Node.js', 'Express', 'Spring' ], know: [ 'Java', { name: '.NET Framework', cname: 'dotnet'} ] },
                    { category: 'Skriptování',
                        like: [ 'Node.js', {name: 'PowerShell', icon: 'https://raw.githubusercontent.com/PowerShell/PowerShell/master/assets/Powershell_64.png' } ], know: [ 'Python', 'Bash' ] },
                    { category: 'Databáze',
